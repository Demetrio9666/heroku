...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('content'); ?> 
        <div class="max-w-xl text-sm text-gray-600">
            <?php echo e(__(' Si es necesario, puede cerrar la sesión de todas las demás sesiones de su navegador en todos sus dispositivos')); ?>
                        ...
                        <div>
                            ...
                            <?php else: ?>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8 text-gray-500">
                                    <path d="M0 0h24v24H0z" stroke="none"></path><rect x="7" y="4" width="10" height="19" rx="1"></rect><path d="M11 5h2M12 17v.01"></path>
                                </svg>
                            <?php endif; ?>
                        </div>
...
<?php $component->withAttributes(['wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']); ?>
                <?php echo e(__('Cerrar sesión en otros navegadores ')); ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingLogout']); ?>
                     ...
                     <?php $__env->slot('content'); ?> 
                        <?php echo e(__('Ingrese su contraseña para confirmar que desea cerrar la sesión de sus otras sesiones de navegador en todos sus dispositivos.')); ?>
